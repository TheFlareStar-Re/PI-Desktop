...
export const fr = {
  ...
  "chat": {
    ...
    "turnFilesTitle": "Modifications de fichiers enregistrées",
    "turnFilesEdited_one": "{{count}} fichier modifié pendant ce tour",
    "turnFilesEdited_other": "{{count}} fichiers modifiés pendant ce tour",
    "turnFilesCount_one": "1 fichier",
    "turnFilesCount_other": "{{count}} fichiers",
    "turnFilesEditTotals": "Totaux des modifications",
    "turnFilesEditTotalsLabel": "Totaux des modifications : {{additions}} ajouts, {{deletions}} suppressions",
    "turnFilesScope": "Modifications de fichiers enregistrées · totaux actifs cumulés, pas nets",
    "turnFilesPartial": "La capture du shell était partielle ; d'autres modifications peuvent manquer",
    "turnFilesUnavailable": "Certaines anciennes exécutions du shell n'ont pas enregistré les modifications de fichiers",
    "turnFilesSubagentExcluded": "les modifications des sous-agents sont exclues",
    "turnFilesPartialOnly": "La capture des modifications était partielle ; aucun chemin enregistré n'est disponible.",
    "turnFilesUnavailableOnly": "Les modifications enregistrées ne sont pas disponibles pour cette ancienne exécution du shell.",
    "turnFilesSubagentOnly": "Aucune modification de fichier enregistrée par l'agent principal n'est disponible dans ce tour chargé.",
    "turnFilesShowMore_one": "Afficher 1 fichier de plus",
    "turnFilesShowMore_other": "Afficher {{count}} fichiers de plus",
    "turnFilesShowLess": "Afficher moins",
    "toolFailed": "Échec",
    "toolDenied": "Refusé",
...
sklm: {
    ...
    "thinkingDisplayModeDesc": "Les deux modes déploient le processus pendant l’exécution et le replient à la fin de la tâche. Détaillé conserve les groupes d'outils imbriqués et le raisonnement en dépliant ; Compact masque le raisonnement terminé.",
