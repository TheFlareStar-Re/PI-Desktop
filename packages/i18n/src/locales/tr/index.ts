...
export const tr = {
  ...
  chat: {
    ...
    turnFilesTitle: "Kaydedilen dosya değişiklikleri",
    turnFilesEdited_one: "Bu turda {{count}} dosya düzenlendi",
    turnFilesEdited_other: "Bu turda {{count}} dosya düzenlendi",
    turnFilesCount_one: "1 dosya",
    turnFilesCount_other: "{{count}} dosya",
    turnFilesEditTotals: "Düzenleme toplamları",
    turnFilesEditTotalsLabel: "Düzenleme toplamları: {{additions}} ekleme, {{deletions}} silme",
    turnFilesScope: "Kaydedilen dosya değişiklikleri · etkin toplamlar net değil birikimlidir",
    turnFilesPartial: "Kabuk yakalaması kısmi kaldı; ek dosya değişiklikleri gösterilmeyebilir",
    turnFilesUnavailable: "Bazı eski kabuk çalıştırmaları dosya değişikliklerini kaydetmedi",
    turnFilesSubagentExcluded: "alt ajan değişiklikleri hariç tutulur",
    turnFilesPartialOnly: "Dosya değişikliği yakalaması kısmi kaldı; kaydedilmiş yol yok.",
    turnFilesUnavailableOnly: "Bu eski kabuk çalıştırması için kaydedilen değişiklikler kullanılamıyor.",
    turnFilesSubagentOnly: "Yüklenen bu turda ana ajanın kaydedilmiş dosya değişikliği yok.",
    turnFilesShowMore_one: "1 dosya daha göster",
    turnFilesShowMore_other: "{{count}} dosya daha göster",
    turnFilesShowLess: "Daha az göster",
...
sklm: {
    ...
    thinkingDisplayModeDesc: "Her iki mod da işlem sürerken süreci açar ve görev bitince kapatır. Ayrıntılı mod, açıldığında iç içe araç grupları ve akıl yürütmeyi gösterir; Sade mod tamamlanan akıl yürütmeyi gizler.",
