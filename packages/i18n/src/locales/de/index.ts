...
"slashCommandSourceUnavailable": "Befehlsliste nicht verfügbar, es wurde nichts gesendet. Bitte erneut versuchen.",
    ...
    "turnFilesTitle": "Aufgezeichnete Dateiänderungen",
    "turnFilesEdited_one": "{{count}} Datei in dieser Runde bearbeitet",
    "turnFilesEdited_other": "{{count}} Dateien in dieser Runde bearbeitet",
    "turnFilesCount_one": "1 Datei",
    "turnFilesCount_other": "{{count}} Dateien",
    "turnFilesEditTotals": "Bearbeitungssummen",
    "turnFilesEditTotalsLabel": "Bearbeitungssummen: {{additions}} Ergänzungen, {{deletions}} Löschungen",
    "turnFilesScope": "Aufgezeichnete Dateiänderungen · aktive Summen sind kumulativ, nicht netto",
    "turnFilesPartial": "Die Shell-Erfassung war unvollständig; weitere Dateiänderungen können fehlen",
    "turnFilesUnavailable": "Einige ältere Shell-Ausführungen haben keine Dateiänderungen aufgezeichnet",
    "turnFilesSubagentExcluded": "Änderungen von Unteragenten sind ausgeschlossen",
    "turnFilesPartialOnly": "Die Erfassung der Dateiänderungen war unvollständig; es sind keine aufgezeichneten Pfade verfügbar.",
    "turnFilesUnavailableOnly": "Für diese ältere Shell-Ausführung sind keine aufgezeichneten Änderungen verfügbar.",
    "turnFilesSubagentOnly": "In diesem geladenen Zug sind keine aufgezeichneten Dateiänderungen des Hauptagenten verfügbar.",
    "turnFilesShowMore_one": "1 weitere Datei anzeigen",
    "turnFilesShowMore_other": "{{count}} weitere Dateien anzeigen",
    "turnFilesShowLess": "Weniger anzeigen",
...
sklm: {
    ...
    "thinkingDisplayModeDesc": "Beide Modi zeigen den Prozess während der Ausführung geöffnet und klappen ihn am Aufgabenende zu. Detailliert hält verschachtelte Tool-Gruppen und Begründungen aufklappbar; Kompakt blendet abgeschlossene Begründungen aus.",
