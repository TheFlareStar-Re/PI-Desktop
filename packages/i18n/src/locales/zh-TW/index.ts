...
export const zhTW = {
  ...
  chat: {
    ...
    turnFilesTitle: "已記錄的檔案改動",
    turnFilesEdited_one: "本輪編輯 {{count}} 個檔案",
    turnFilesEdited_other: "本輪編輯 {{count}} 個檔案",
    turnFilesCount_one: "1 個檔案",
    turnFilesCount_other: "{{count}} 個檔案",
    turnFilesEditTotals: "編輯總計",
    turnFilesEditTotalsLabel: "編輯總計：新增 {{additions}} 行，刪除 {{deletions}} 行",
    turnFilesScope: "已記錄的檔案改動 · 目前總計為累計編輯量，並非淨差異",
    turnFilesPartial: "命令列改動僅部分擷取，可能還有檔案改動未顯示",
    turnFilesUnavailable: "部分舊版命令列記錄未保存檔案改動",
    turnFilesSubagentExcluded: "不包含子智慧體改動",
    turnFilesPartialOnly: "檔案改動僅部分擷取，暫無可用的已記錄路徑。",
    turnFilesUnavailableOnly: "此舊版命令列記錄沒有可用的檔案改動。",
    turnFilesSubagentOnly: "本次已載入回合中沒有主智慧體記錄的檔案改動。",
    turnFilesShowMore_one: "再顯示 1 個檔案",
    turnFilesShowMore_other: "再顯示 {{count}} 個檔案",
    turnFilesShowLess: "收起",
    toolFailed: "失敗",
    toolDenied: "已拒絕",
    toolCompleted: "已完成",
    toolCall: "工具",
...
sklm: {
    ...
    thinkingDisplayModeDesc: "兩種模式都會在執行時展開處理過程，任務結束後統一收起。詳細模式保留可展開查看的巢狀工具群組和推理內容，精簡模式隱藏已完成的推理。",
