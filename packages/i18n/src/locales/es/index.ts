...
"slashCommandSourceUnavailable": "La lista de comandos no está disponible, así que no se envió nada. Inténtalo de nuevo.",
    ...
    "turnFilesTitle": "Cambios de archivos registrados",
    "turnFilesEdited_one": "{{count}} archivo editado en este turno",
    "turnFilesEdited_other": "{{count}} archivos editados en este turno",
    "turnFilesCount_one": "1 archivo",
    "turnFilesCount_other": "{{count}} archivos",
    "turnFilesEditTotals": "Totales de edición",
    "turnFilesEditTotalsLabel": "Totales de edición: {{additions}} adiciones, {{deletions}} eliminaciones",
    "turnFilesScope": "Cambios de archivos registrados · los totales activos son acumulados, no netos",
    "turnFilesPartial": "La captura del shell fue parcial; pueden faltar otros cambios de archivos",
    "turnFilesUnavailable": "Algunas ejecuciones antiguas del shell no registraron cambios de archivos",
    "turnFilesSubagentExcluded": "se excluyen los cambios de subagentes",
    "turnFilesPartialOnly": "La captura de cambios de archivos fue parcial; no hay rutas registradas disponibles.",
    "turnFilesUnavailableOnly": "Los cambios registrados no están disponibles para esta ejecución antigua del shell.",
    "turnFilesSubagentOnly": "No hay cambios de archivos registrados por el agente principal en este turno cargado.",
    "turnFilesShowMore_one": "Mostrar 1 archivo más",
    "turnFilesShowMore_other": "Mostrar {{count}} archivos más",
    "turnFilesShowLess": "Mostrar menos",
    "toolFailed": "Fallido",
    "toolDenied": "Denegado",
    "toolCompleted": "Hecho",
...
sklm: {
    ...
    "thinkingDisplayModeDesc": "Ambos modos expanden el proceso durante la ejecución y lo contraen al terminar la tarea. Detallado conserva grupos de herramientas anidados y el razonamiento al expandir; Compacto oculta el razonamiento completado.",
