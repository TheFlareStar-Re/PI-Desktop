...
export const ko = {
  ...
  chat: {
    ...
    turnFilesTitle: "기록된 파일 변경",
    turnFilesEdited_one: "이번 차례에 파일 {{count}}개 편집",
    turnFilesEdited_other: "이번 차례에 파일 {{count}}개 편집",
    turnFilesCount_one: "파일 1개",
    turnFilesCount_other: "파일 {{count}}개",
    turnFilesEditTotals: "편집 합계",
    turnFilesEditTotalsLabel: "편집 합계: 추가 {{additions}}개, 삭제 {{deletions}}개",
    turnFilesScope: "기록된 파일 변경 · 활성 합계는 순변경이 아닌 누적값",
    turnFilesPartial: "셸 캡처가 일부만 완료되어 다른 파일 변경이 표시되지 않을 수 있음",
    turnFilesUnavailable: "일부 이전 셸 실행에서는 파일 변경을 기록하지 않음",
    turnFilesSubagentExcluded: "하위 에이전트 변경은 제외됨",
    turnFilesPartialOnly: "파일 변경 캡처가 일부만 완료되어 기록된 경로가 없습니다.",
    turnFilesUnavailableOnly: "이 이전 셸 실행의 기록된 변경을 사용할 수 없습니다.",
    turnFilesSubagentOnly: "불러온 이 턴에는 주 에이전트가 기록한 파일 변경이 없습니다.",
    turnFilesShowMore_one: "파일 1개 더 보기",
    turnFilesShowMore_other: "파일 {{count}}개 더 보기",
    turnFilesShowLess: "간단히 보기",
    toolFailed: "실패",
    toolDenied: "거부됨",
    toolCompleted: "완료",
    toolCall: "도구",
...
sklm: {
    ...
    thinkingDisplayModeDesc: "두 모드 모두 실행 중에는 과정을 펼치고 작업이 끝나면 접습니다. 상세는 펼쳐서 볼 수 있는 중첩 도구 그룹과 추론을 유지하고, 간결은 완료된 추론을 숨깁니다.",
