export const en = {
  ...
  chat: {
    ...
    turnFilesTitle: "Recorded file changes",
    turnFilesEdited_one: "Edited {{count}} file this turn",
    turnFilesEdited_other: "Edited {{count}} files this turn",
    turnFilesCount_one: "1 file",
    turnFilesCount_other: "{{count}} files",
    turnFilesEditTotals: "Edit totals",
    turnFilesEditTotalsLabel: "Edit totals: {{additions}} additions, {{deletions}} deletions",
    turnFilesScope: "Recorded file changes · active totals are cumulative, not net",
    turnFilesPartial: "Shell capture was partial; additional file changes may not be shown",
    turnFilesUnavailable: "Some older shell runs did not record file changes",
    turnFilesSubagentExcluded: "subagent changes are excluded",
    turnFilesPartialOnly: "File change capture was partial; no recorded paths are available.",
    turnFilesUnavailableOnly: "Recorded changes are unavailable for this older shell run.",
    turnFilesSubagentOnly: "No main-agent recorded file changes are available in this loaded turn.",
    turnFilesShowMore_one: "Show 1 more file",
    turnFilesShowMore_other: "Show {{count}} more files",
    turnFilesShowLess: "Show less",
    toolFailed: "Failed",
    toolDenied: "Denied",
    toolCompleted: "Done",
    toolCall: "Tool",
...
sklm: {
    ...
    thinkingDisplayModeDesc: "Both modes expand the process while running and collapse it when the task ends. Detailed keeps nested tool groups and reasoning available on expansion; Compact hides completed reasoning.",
