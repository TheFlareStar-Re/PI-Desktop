...
export const zhCN = {
  ...
  chat: {
    ...
    turnFilesTitle: "已记录的文件改动",
    turnFilesEdited_one: "本轮编辑 {{count}} 个文件",
    turnFilesEdited_other: "本轮编辑 {{count}} 个文件",
    turnFilesCount_one: "1 个文件",
    turnFilesCount_other: "{{count}} 个文件",
    turnFilesEditTotals: "编辑总计",
    turnFilesEditTotalsLabel: "编辑总计：新增 {{additions}} 行，删除 {{deletions}} 行",
    turnFilesScope: "已记录的文件改动 · 当前总计为累计编辑量，并非净差异",
    turnFilesPartial: "命令行改动仅部分捕获，可能还有文件改动未显示",
    turnFilesUnavailable: "部分旧版命令行记录未保存文件改动",
    turnFilesSubagentExcluded: "不包含子智能体改动",
    turnFilesPartialOnly: "文件改动仅部分捕获，暂无可用的已记录路径。",
    turnFilesUnavailableOnly: "此旧版命令行记录没有可用的文件改动。",
    turnFilesSubagentOnly: "本次已加载回合中没有主智能体记录的文件改动。",
    turnFilesShowMore_one: "再显示 1 个文件",
    turnFilesShowMore_other: "再显示 {{count}} 个文件",
...
sklm: {
    ...
    thinkingDisplayModeDesc: "两种模式都会在运行时展开处理过程，任务结束后统一收起。详细模式保留可展开查看的嵌套工具分组和推理内容，精简模式隐藏已完成的推理。",
